...
# using routes in a controller or the contents
# of a file if it exists
#
# Server:
# $> python3 routes_dserver.py
# Client:
# $> nc localhost 5004
# GET /hello.html
...
while True:
    ...
    with conn:
        ...
        if route=='home':
            response = controllers.show_home()
        elif route=='tasks':
            response = controllers.show_tasks()
        ###############################################
